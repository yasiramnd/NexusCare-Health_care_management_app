...
export default function ScanID({ onBack, onViewPrescriptions }) {
  ...
  return (
    <div className="scan-page" style={{ minHeight: "auto", background: "transparent", padding: 0, display: "flex", flexDirection: "column", alignItems: "center" }}>

      {/* HEADER */}
      <div className="scan-header" style={{ padding: "0 0 10px", width: "100%", maxWidth: "500px" }}>
        <h1 className="scan-title">Scan Patient QR</h1>
      </div>

      {/* SUBTITLE */}
      <p className="scan-subtitle" style={{ width: "100%", maxWidth: "500px", color: "var(--p-text-dim)" }}>
        Scan patient's QR code to quickly access their prescription history and information.
      </p>

      {/* CONTENT AREA */}
      <div className="scan-content" style={{ flex: "none", width: "100%", maxWidth: "500px", padding: "20px 0" }}>
